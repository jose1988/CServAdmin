 ...
 * objetos de la clase prioridad retornados por las operaciones web. Las
...
public class WR_prioridad {
    ...
    /**
     * Lista de objetos de la clase prioridad que son retornados por la
     * operacion web.
     */
    private ArrayList<prioridad> prioridads;

    /**
     * Constructor
     */
    public WR_prioridad() {
        prioridads = new ArrayList<prioridad>();
    }

    /**
     * Ingresa un nuevo objeto de la clase prioridad a la lista de prioridades
     * del envoltorio.
     *
     * @param bandejaActual objeto de la clase prioridad que se desea añadir a
     * la lista
     */
    public void ingresarPrioridad(prioridad nuevaPrioridad) {
        this.prioridads.add(nuevaPrioridad);
    }
    ...
    /**
     * Obtiene la lista de prioridades que posee el envoltorio. Dependiendo de
     * la operacion que llene el envoltorio, esta lista podria tener de 0 a N
     * elementos
     *
     * @return Lista de las prioridades obtenidas
     */
    public ArrayList<prioridad> getPrioridads() {
        return prioridads;
    }

    /**
     * Asigna una lista de prioridades al envoltorio.
     *
     * @param prioridads Lista de objetos de la clase prioridad
     */
    public void setPrioridads(ArrayList<prioridad> prioridads) {
