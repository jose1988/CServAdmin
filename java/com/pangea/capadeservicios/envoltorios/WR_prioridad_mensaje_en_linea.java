 ...
 * objetos de la clase prioridad_mensaje_en_linea retornados por las operaciones
 ...
 */
public class WR_prioridad_mensaje_en_linea {
    ...
    /**
     * Lista de objetos de la clase prioridad_mensaje_en_linea que son
     * retornados por la operacion web.
     */
    private ArrayList<prioridad_mensaje_en_linea> prioridad_Mensaje_En_Lineas;

    /**
     * Constructor
     */
    public WR_prioridad_mensaje_en_linea() {
        prioridad_Mensaje_En_Lineas = new ArrayList<prioridad_mensaje_en_linea>();
    }
    ...
    /**
     * Obtiene la lista de prioridad_mensaje_en_linea que posee el envoltorio.
     * Dependiendo de la operacion que llene el envoltorio, esta lista podria
     * tener de 0 a N elementos
     *
     * @return Lista de las prioridad_mensaje_en_linea obtenidas
     */
    public ArrayList<prioridad_mensaje_en_linea> getPrioridad_Mensaje_En_Lineas() {
        return prioridad_Mensaje_En_Lineas;
    }

    /**
     *
     * @param prioridad_Mensaje_En_Lineas
     */
    public void setPrioridad_Mensaje_En_Lineas(ArrayList<prioridad_mensaje_en_linea> prioridad_Mensaje_En_Lineas) {
        this.prioridad_Mensaje_En_Lineas = prioridad_Mensaje_En_Lineas;
    }
}
