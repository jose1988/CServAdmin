 ...
 * objetos de la clase auditoria retornados por las operaciones web. Las
...
public class WR_auditoria {
    ...
    /**
     * Lista de objetos de la clase auditoria que son retornados por la
     * operacion web.
     */
    ...
    /**
     * Obtiene la lista de auditorias que posee el envoltorio. Dependiendo de la
     * operacion que llene el envoltorio, esta lista podria tener de 0 a N
     * elementos
     *
     * @return Lista de las auditorias obtenidas
     */
    ...
    /**
     * Asigna una lista de auditorias al envoltorio.
     *
     * @param auditorias Lista de objetos de la clase auditoria
     */
