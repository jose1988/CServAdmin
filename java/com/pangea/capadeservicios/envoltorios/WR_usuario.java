 ...
 * objetos de la clase usuario retornados por las operaciones web. Las
...
public class WR_usuario {
    ...
    /**
     * Lista de objetos de la clase usuario que son retornados por la operacion
     * web.
     */
    ...
    /**
     * Obtiene la lista de usuarios que posee el envoltorio. Dependiendo de la
     * operacion que llene el envoltorio, esta lista podria tener de 0 a N
     * elementos
     *
     * @return Lista de los usuarios obtenidos
     */
    ...
    /**
     * Ingresa un nuevo objeto de la clase usuario a la lista de usuarios del
     * envoltorio.
     *
     * @param nuevoUsuario objeto de la clase usuario que se desea añadir a la
     * lista
     */
