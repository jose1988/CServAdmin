 ...
 * cuando se trata de una lista de ellos. Las instancias de esta clase almacenan
 * tanto el resultado de la operacion ejecutada como los objetos solicitados.
 *
 * @author pangea technologies c.a.
 */
public class WR_equivalencia_tiempos {
    ...
    /**
     * Lista de objetos de la clase equivalencia_tiempo que son retornados por
     * la operacion web.
     */
    private ArrayList<equivalencia_tiempo> equivalenciaTiempos;

    /**
     * Constructor
     */
    public WR_equivalencia_tiempos() {
        equivalenciaTiempos = new ArrayList<equivalencia_tiempo>();
    }

    /**
     * Ingresa un nuevo objeto de la clase equivalencia_tiempo a la lista de
     * equivalencia_tiempo del envoltorio.
     *
     * @param nuevaEquivalencia objeto de la clase equivalencia_tiempo que se
     * desea añadir a la lista
     */
    public void ingresarEquivalencia(equivalencia_tiempo nuevaEquivalencia) {
        this.equivalenciaTiempos.add(nuevaEquivalencia);
    }
    ...
    /**
     * Obtiene la lista de equivalencia_tiempo que posee el envoltorio.
     * Dependiendo de la operacion que llene el envoltorio, esta lista podria
     * tener de 0 a N elementos
     *
     * @return Lista de las equivalencia_tiempo obtenidas
     */
    public ArrayList<equivalencia_tiempo> getEquivalenciaTiempos() {
        return equivalenciaTiempos;
    }

    /**
     * Asigna una lista de equivalencia_tiempo al envoltorio.
     *
     * @param equivalenciaTiempos Lista de objetos de la clase
     * equivalencia_tiempo
     */
    public void setEquivalenciaTiempos(ArrayList<equivalencia_tiempo> equivalenciaTiempos) {
        this.equivalenciaTiempos = equivalenciaTiempos;
    }
}
