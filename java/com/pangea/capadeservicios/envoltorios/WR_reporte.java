 ...
 * objetos de la clase reporte retornados por las operaciones web. Las
...
public class WR_reporte {
    ...
    /**
     * Lista de objetos de la clase reporte que son retornados por la operacion
     * web.
     */
    ...
    /**
     * Ingresa un nuevo objeto de la clase reporte a la lista de reportes del
     * envoltorio.
     *
     * @param nuevoReporte objeto de la clase reporte que se desea añadir a la
     * lista
     */
    public void ingresarReporte(reporte nuevoReporte) {
    ...
    /**
     * Obtiene la lista de reportes que posee el envoltorio. Dependiendo de la
     * operacion que llene el envoltorio, esta lista podria tener de 0 a N
     * elementos
     *
     * @return Lista de los reportes obtenidos
     */
    ...
    /**
     * Asigna una lista de reportes al envoltorio.
     *
     * @param reportes Lista de objetos de la clase reporte
     */
