...
import com.pangea.capadeservicios.beans.condicionFacade;
...
@SessionScoped
public class condicionController implements Serializable {

    private condicion current;
    private DataModel items = null;
    @EJB
    private com.pangea.capadeservicios.beans.condicionFacade ejbFacade;
    ...
    private condicionFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (condicion) getItems().getRowData();
