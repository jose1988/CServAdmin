...
public class auditoriaController implements Serializable {
    ...
    @EJB
    private com.pangea.capadeservicios.beans.auditoriaFacade ejbFacade;
    ...
    public String prepareView() {
        current = (auditoria) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("auditoriaCreated"));
    ...
    public static class auditoriaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof auditoria) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + auditoria.class.getName());
            }
        }
    }
}
