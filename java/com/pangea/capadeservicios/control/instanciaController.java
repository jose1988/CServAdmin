...
@ManagedBean(name = "instanciaController")
@SessionScoped
public class instanciaController implements Serializable {

    private instancia current;
    private DataModel items = null;
    @EJB
    private com.pangea.capadeservicios.beans.instanciaFacade ejbFacade;
    ...
    public String prepareView() {
        current = (instancia) getItems().getRowData();
    ...
    public static class instanciaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            instanciaController controller = (instanciaController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "instanciaController");
