...
public class politicaController implements Serializable {
    ...
    @EJB
    private com.pangea.capadeservicios.beans.politicaFacade ejbFacade;
    ...
    public politica getSelected() {
        if (current == null) {
            current = new politica();
            selectedItemIndex = -1;
        }
        return current;
    }

    private politicaFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (politica) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("politicaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("politicaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("politicaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
