...
import com.pangea.capadeservicios.beans.actividadFacade;
import com.pangea.capadeservicios.beans.grupoFacade;
import com.pangea.capadeservicios.beans.instanciaFacade;
import com.pangea.capadeservicios.beans.periodoFacade;
import com.pangea.capadeservicios.beans.periodo_grupo_procesoFacade;
import com.pangea.capadeservicios.beans.procesoFacade;
import com.pangea.capadeservicios.beans.sesionFacade;
import com.pangea.capadeservicios.beans.tareaFacade;
...
import com.pangea.capadeservicios.entidades.prioridad;
...
import com.pangea.capadeservicios.envoltorios.WR_instancia;
import com.pangea.capadeservicios.envoltorios.WR_periodo;
import com.pangea.capadeservicios.envoltorios.WR_proceso;
...
//            }
    ...
    public WR_instancia consultarInstanciaXMaxId() {
        WR_instancia Resultado = new WR_instancia();
        try {
            instancia idInstancia = new instancia();
            idInstancia.setId(myInstanciaFacade.buscarInstanciaXMaxId());
            Resultado.ingresarInstancia(idInstancia);
            Resultado.setEstatus("OK");
        } catch (Exception e) {
            Resultado.setEstatus("FAIL");
    ...
    /**
     * Consume el servicio ConsultarCandidatos.
     *
     ...
     * @see WrUsuario
     */
    private WrUsuario consultarCandidatos(com.pangea.capadeservicios.clienteweb.Actividad actividadActual) {
        com.pangea.capadeservicios.clienteweb.AplicarPolitica port = service_1.getAplicarPoliticaPort();
        return port.consultarCandidatos(actividadActual);
    }
